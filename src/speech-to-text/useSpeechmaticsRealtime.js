...
const getWebSocketURL = () => {
    ...
    return `${protocol}://${host}/ws?service=speechmatics`;
};

const SM_WS_URL = getWebSocketURL();

export default function useSpeechmaticsRealtime() {
    ...
    const stopListening = async () => {
        ...
        try {
            ...
            setTimeout(() => wsRef.current?.close(), 150);
        } catch (e) {
            console.log(e)
        }
        ...
        if (audioContextRef.current) {
            try {
                ...
                console.warn("Speechmatics AudioContext already closed", e);
            }
